...
public class SearchService {
    private static final String SOLR_URL = "http://127.0.0.1:8099/solr/core_demo";
    ...
    public List<Question> searchQuestion(String keyword, int offset, int count,
        ...
        SolrQuery query = new SolrQuery(QUESTION_TITLE+":"+keyword+" OR "+QUESTION_CONTENT+":"+keyword);
        query.setRows(count);
